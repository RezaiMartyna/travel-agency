...
const mockProps = {
  title: 'HAPPY HOURS',
  promoDescription: 'It is your time',
};
...
describe('Component HappyHourAd', () => {
  ...
  it('should render heading with text from title props', () => {
...
describe('Component HappyHourAd shows promoDesription within HappyHour', () => {
  checkDescriptionAtTime('12:57:58', mockProps.promoDescription);
  checkDescriptionAtTime('12:59:59', mockProps.promoDescription);
  checkDescriptionAtTime('12:00:00', mockProps.promoDescription);
});

describe('Component HappyHourAd with mocked Date and delay just before HappyHour', () => {
  checkDescriptionAfterTime('11:57:58', 2, '120');
  checkDescriptionAfterTime('11:59:58', 1, '1');
